...
# plt.figure()
# plt.suptitle("Total Stroke Management Times by Data Subset - 3hosp 10% ECR")
#
# combinations =
#     ("rural", 0, 0),
#     ("rural", 1, 0),
