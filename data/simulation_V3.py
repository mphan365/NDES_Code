...
hosp_2_data_dict = {
    ...
    "transfer_to_austin_data": "data/internal/hospitalupdate/t2austin.csv",
    "transfer_to_monash_data": "data/internal/hospitalupdate/t2monash.csv",
    "transfer_to_rmh_data": "data/internal/hospitalupdate/t2rmh.csv",
    "transfer_to_alfred_data": "data/internal/hospitalupdate/t2alfred.csv"
}
...
hosp_3_data_dict_alfred = {
    "rural_hospital_data": "data/internal/hospitalupdate/3hosp_alfred/rhosp.csv",
    "peripheral_hospital_data": "data/internal/hospitalupdate/3hosp_alfred/pschosp.csv",
    "central_hospital_data": "data/internal/hospitalupdate/3hosp_alfred/cschosp.csv",
    "transfer_to_austin_data": "data/internal/hospitalupdate/t2austin.csv",
    "transfer_to_monash_data": "data/internal/hospitalupdate/t2monash.csv",
    "transfer_to_rmh_data": "data/internal/hospitalupdate/t2rmh.csv",
    "transfer_to_alfred_data": "data/internal/hospitalupdate/t2alfred.csv"
...
hosp_4_data_dict = {
    "rural_hospital_data": "data/internal/hospitalupdate/4hosp/rhosp.csv",
    "peripheral_hospital_data": "data/internal/hospitalupdate/4hosp/pschosp.csv",
    "central_hospital_data": "data/internal/hospitalupdate/4hosp/cschosp.csv",
    "transfer_to_austin_data": "data/internal/hospitalupdate/t2austin.csv",
    "transfer_to_monash_data": "data/internal/hospitalupdate/t2monash.csv",
    "transfer_to_rmh_data": "data/internal/hospitalupdate/t2rmh.csv",
    "transfer_to_alfred_data": "data/internal/hospitalupdate/t2alfred.csv"
...
hosp_data_dict_list = [hosp_2_data_dict, hosp_3_data_dict, hosp_3_data_dict_alfred, hosp_4_data_dict]

# Variable Data Imports
...
hosp_data_dict
    ...
    strokes_per_year = variables_df.loc["strokes_per_year"].value
    start_date = str(int(variables_df.loc["start_date"].value))
    simulation_runtime = variables_df.loc["simulation_runtime"].value
    burn_in = variables_df.loc["burn_in"].value

    proportion_nearest_rural = variables_df.loc["proportion_nearest_rural"].value
    proportion_nearest_peripheral = variables_df.loc["proportion_nearest_peripheral"].value
    proportion_nearest_central = variables_df.loc["proportion_nearest_central"].value

    proportion_transfer = variables_df.loc["proportion_transfer"].value
    proportion_to_receive_ECR = variables_df.loc["proportion_to_receive_ECR"].value

    amb_call_time_q1 = variables_df.loc["amb_call_time_q1"].value
    amb_call_time_median = variables_df.loc["amb_call_time_median"].value
    amb_call_time_q3 = variables_df.loc["amb_call_time_q3"].value

    amb_arrive_time_q1 = variables_df.loc["amb_arrive_time_q1"].value
    amb_arrive_time_median = variables_df.loc["amb_arrive_time_median"].value
    amb_arrive_time_q3 = variables_df.loc["amb_arrive_time_q3"].value

    amb_assess_time_q1 = variables_df.loc["amb_assess_time_q1"].value
    amb_assess_time_median = variables_df.loc["amb_assess_time_median"].value
    amb_assess_time_q3 = variables_df.loc["amb_assess_time_q3"].value

    hosp_admit_time_q1 = variables_df.loc["hosp_admit_time_q1"].value
    hosp_admit_time_median = variables_df.loc["hosp_admit_time_median"].value
    hosp_admit_time_q3 = variables_df.loc["hosp_admit_time_q3"].value

    cschosp_admit_time_median = variables_df.loc["cschosp_admit_time_median"].value
    cschosp_admit_time_sd = variables_df.loc["cschosp_admit_time_sd"].value

    csc_ct_scan_time_median = variables_df.loc["csc_ct_scan_time_median"].value
    csc_ct_scan_time_sd = variables_df.loc["csc_ct_scan_time_sd"].value

    ct_scan_time_q1 = variables_df.loc["ct_scan_time_q1"].value
    ct_scan_time_median = variables_df.loc["ct_scan_time_median"].value
    ct_scan_time_q3 = variables_df.loc["ct_scan_time_q3"].value

    csc_door_to_puncture_median = variables_df.loc["csc_door_to_puncture_median"].value
    csc_door_to_puncture_sd = variables_df.loc["csc_door_to_puncture_sd"].value

    transfer_amb_arrive_time_q1 = variables_df.loc["transfer_amb_arrive_time_q1"].value
    transfer_amb_arrive_time_median = variables_df.loc["transfer_amb_arrive_time_median"].value
    transfer_amb_arrive_time_q3 = variables_df.loc["transfer_amb_arrive_time_q3"].value

    transfer_amb_depart_time_q1 = variables_df.loc["transfer_amb_depart_time_q1"].value
    transfer_amb_depart_time_median = variables_df.loc["transfer_amb_depart_time_median"].value
    transfer_amb_depart_time_q3 = variables_df.loc["transfer_amb_depart_time_q3"].value

    csc_receive_ecr_transfer_time_q1 = variables_df.loc["csc_receive_ecr_transfer_time_q1"].value
    csc_receive_ecr_transfer_time_median = variables_df.loc["csc_receive_ecr_transfer_time_median"].value
    csc_receive_ecr_transfer_time_q3 = variables_df.loc["csc_receive_ecr_transfer_time_q3"].value

    angio_reperfusion_time_q1 = variables_df.loc["angio_reperfusion_time_q1"].value
    angio_reperfusion_time_median = variables_df.loc["angio_reperfusion_time_median"].value
    angio_reperfusion_time_q3 = variables_df.loc["angio_reperfusion_time_q3"].value

    angio_cutoff_time_hours = variables_df.loc["angio_cutoff_time_hours"].value
    angio_optimal_time_hours = variables_df.loc["angio_optimal_time_hours"].value
    acutebed_stay_median_hours = variables_df.loc["acutebed_stay_median_hours"].value
    acute_bed_stay_sd_hours = variables_df.loc["acute_bed_stay_sd_hours"].value
    proportion_transferred_requiring_CT = variables_df.loc["proportion_transferred_requiring_CT"].value
    ...
    angio_optimal_time_mins = angio_optimal_time_hours*60
    ...
    transfer_to_alfred_data = (
        pd.read_csv(hosp_data_dict["transfer_to_alfred_data"]).set_index("Hospitals").T
    )
    ...
    def get_angio_category(time_for_treatment_wait):
        if time_for_treatment_wait < angio_optimal_time_mins:
            return 1
        elif angio_optimal_time_mins <= time_for_treatment_wait < angio_cutoff_time_mins:
            return 2
        else:
            return 3
    ...
    def get_hospital_of_transfer(hospital, hour): # TODO: Generalise this function
        # monash fastest choice = 0
        # rmh fastest choice = 1
        # austin fatest choice = 2
        # alfred fastest choice = 3
        central_hospitals = ["Monash Health", "Royal Melbourne Hospital", "Austin Health", "The Alfred"]
        if hosp_data_dict == hosp_2_data_dict:
            ...
            #alfred_time = transfer_to_alfred_data[hospital].iloc[hour]
        ...
        elif hosp_data_dict == hosp_3_data_dict:
            ...
            if monash_time < austin_time and monash_time < rmh_time:
                choice = 0
                return central_hospitals[choice], choice, monash_time

            elif rmh_time < monash_time and rmh_time < austin_time:
                choice = 1
                return central_hospitals[choice], choice, rmh_time
            else:
                choice = 2
        ...
        elif hosp_data_dict == hosp_3_data_dict_alfred:
            ...
            if monash_time < alfred_time and monash_time < rmh_time:
                choice = 0
                return central_hospitals[choice], choice, monash_time
            elif rmh_time < monash_time and rmh_time < alfred_time:
                choice = 1
                return central_hospitals[choice], choice, rmh_time
            else:
                choice = 3
                return central_hospitals[choice], choice, alfred_time
            ...
            if monash_time < austin_time and monash_time < rmh_time and monash_time < alfred_time:
                choice = 0
                return central_hospitals[choice], choice, monash_time
            elif rmh_time < monash_time and rmh_time < austin_time and rmh_time < alfred_time:
                choice = 1
                return central_hospitals[choice], choice, rmh_time
            elif austin_time < monash_time and austin_time < rmh_time and austin_time < alfred_time:
                choice = 2
                return central_hospitals[choice], choice, austin_time
            else:
                choice = 3
